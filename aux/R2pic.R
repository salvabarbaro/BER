...
states <- data.frame(statenumber = 2:17, 
                     Land = c("BW", "BY", "BE", "BR", "HB", "HH", "HE", "MV",
                              "NI", "NW", "RP", "SL", "SN", "ST", "SH", "TH"))

## already present: 'data' from the main replication file
plot.data <- data %>% 
...
ggsave("~/Documents/Research/Yardstick/BER/git/6842e459f8d02615df55d365/PUCH/R2picTHREE.pdf", 
       width = 16, height = 9, plot = R2pic.three)
